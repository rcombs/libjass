            ...
            (function (parser) {
                ...
                var SrtStreamParser = function () {
                    function SrtStreamParser(stream) {
                        ...
                        var newStyle = new libjass.Style(new libjass.Map().set("Name", "Default").set("Italic", "0").set("Bold", "0").set("Underline", "0").set("StrikeOut", "0").set("Fontname", "").set("Fontsize", "50").set("ScaleX", "100").set("ScaleY", "100").set("Spacing", "0").set("Angle", "0").set("PrimaryColour", "&H0000FFFF").set("SecondaryColour", "&H00000000").set("OutlineColour", "&H00000000").set("BackColour", "&H00000000").set("Outline", "1").set("BorderStyle", "1").set("Shadow", "1").set("Alignment", "2").set("MarginL", "80").set("MarginR", "80").set("MarginV", "35"));
                    ...
                    SrtStreamParser.prototype._onNextLine = function (line) {
                        ...
                        if (line === null) {
                            if (this._currentDialogueNumber !== null && this._currentDialogueStart !== null && this._currentDialogueEnd !== null && this._currentDialogueText !== null) {
                                this._ass.dialogues.push(new libjass.Dialogue(new libjass.Map().set("Style", "Default").set("Start", this._currentDialogueStart).set("End", this._currentDialogueEnd).set("Layer", "0").set("Text", this._currentDialogueText), this._ass));
                            }
                            this._deferred.resolve(this._ass);
                            return;
                        }
